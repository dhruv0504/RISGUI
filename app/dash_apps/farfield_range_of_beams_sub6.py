    ...
    dash_app.layout = dbc.Container([
        dbc.Row([
            dbc.Col([
                ...
                dbc.Label("Incident θ (deg)"),html.Br(),html.Br(),
                dcc.Input(id='ti', type='number', value=0, step=1),

                dbc.Label("Incident φ (deg)", className="mt-2"),html.Br(),html.Br(),
                dcc.Input(id='pi', type='number', value=0, step=1),

                html.Hr(),
                dbc.Label("Reflection θ: Start"),html.Br(),html.Br(),
                dcc.Input(id='trstart', type='number', value=0, step=1),
                dbc.Label("Step"),html.Br(),html.Br(),
                dcc.Input(id='trsteps', type='number', value=1, step=1),
                dbc.Label("Stop"),html.Br(),html.Br(),
                dcc.Input(id='trstop', type='number', value=10, step=1),

                html.Hr(),
                dbc.Label("Reflection φ: Start"),html.Br(),html.Br(),
                dcc.Input(id='prstart', type='number', value=0, step=1),
                dbc.Label("Step"),html.Br(),html.Br(),
                dcc.Input(id='prsteps', type='number', value=1, step=1),
                dbc.Label("Stop"),html.Br(),html.Br(),
                dcc.Input(id='prstop', type='number', value=10, step=1),

                html.Hr(),
                dbc.Label("RIS Size (RS1 x RS2)"),html.Br(),html.Br(),
                dcc.Input(id='RS1', type='number', value=28, step=1),html.Br(),html.Br(),
                dcc.Input(id='RS2', type='number', value=36, step=1),html.Br(),html.Br(),

                html.Hr(),
                dbc.Label("Dynamic Range (dB)"),html.Br(),html.Br(),
                dcc.Input(id='DR1', type='number', value=-30, step=1),html.Br(),html.Br(),
                dcc.Input(id='DR2', type='number', value=0, step=1),html.Br(),html.Br(),
